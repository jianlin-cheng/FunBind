...
def get_model(model_name, device='cpu'):
    ...
    cache_dir = "/bml/LAFA/FunBind/hub"
...
def main():
    ...
    parser.add_argument('--ontology', type=str, default="", help="Path to data files")
    ...
    parser.add_argument('--output', type=str, default="results_cc", help="File to save output")
    ...
    # args.data_path = "/software/FunBind/checkpoints"
    # args.sequence_path = "/software/FunBind/checkpoints/examples/classification/sequence.fasta"
    # args.interpro_path = "/software/FunBind/checkpoints/examples/classification/interpro.txt"
    # args.text_path = "/software/FunBind/checkpoints/examples/classification/text.txt"
    # args.structure_path = "/software/FunBind/checkpoints/examples/classification/structure.fasta"
   
    # cmd for prediction from text: 
    # python funbind_main.py --data-path /software/FunBind/checkpoints --text-path /software/FunBind/checkpoints/examples/classification/text.txt
    # python funbind_main.py --data-path /software/FunBind/checkpoints --interpro-path /software/FunBind/checkpoints/examples/classification/interpro.txt
    # python funbind_main.py --data-path /software/FunBind/checkpoints --structure-path /software/FunBind/checkpoints/examples/classification/structure.fasta
    # python funbind_main.py --data-path /software/FunBind/checkpoints --sequence-path /software/FunBind/checkpoints/examples/classification/sequence.fasta
...
# python funbind_main.py --data-path ./checkpoints --text-path ./checkpoints/examples/classification/text.txt --interpro-path ./checkpoints/examples/classification/interpro.txt --structure-path ./checkpoints/examples/classification/structure.fasta --sequence-path ./checkpoints/examples/classification/sequence.fasta

    
'''
python classification.py --data-path ./checkpoints --text-path ./checkpoints/examples/classification/text.txt --interpro-path ./checkpoints/examples/classification/interpro.txt --structure-path ./checkpoints/examples/classification/structure.fasta --sequence-path ./checkpoints/examples/classification/sequence.fasta --ontology CC
