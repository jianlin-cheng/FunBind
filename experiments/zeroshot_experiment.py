...
def run_experiment(modality="Sequence", ontology=None, step_size=3, i=0):
...
def run_n_times(ontology, modality, n=10):
    ...
    for i in range(n):
        ...
        metrics = run_experiment(modality=modality, ontology=ontology, step_size=12, i=i)
        for key, value in metrics.items():
            print(key, value)
            all_runs_metrics[key].append(value)

     # Calculate and print mean and standard deviation in a table format
    print(f"\nResults for {modality} {ontology} (Mean +/- SD):")
    print("-" * 30)
...
modality = "Structure"  # "Sequence", "Structure", "Text", "Interpro"
ontology = "BP"
